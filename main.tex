...
\subsection*{Genome-wide association studies identify candidate genes for lipid remodeling}

We conducted GWAS with three flavors of the same lipidomics data: (1) individual lipid species, (2) aggregates of lipid class abundances, and (3) all conceivable pairwise ratios of these aggregated classes. Utilizing a significance threshold of $-\log_{10}(p)\ge7$ for individual lipids, sums, and ratios, we identified 2189 and 7363 genes associated with lipid species (Supplementary Table~S6 and S8), and 10360 genes associated with the ratios of summed classes (Supplementary Table~S4) in a 25~kb window for Control and LowInput respectively. The full set of annotations is available in Supplementary Tables~S6--S9. Here, the candidate genes can be identified using (i) genes with the highest occurrences, (ii) GWAS pertaining to lipid class, (iii) sum or ratio of lipids, and (iv) individual compounds of interest (Fig.~\ref{fig:Fig3}). We report LowInput results below; all GWAS results are available in the Shiny application.
